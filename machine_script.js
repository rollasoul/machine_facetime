...
window.addEventListener('load', function() {
    ...
    async function faceCheck() {
        ...
        //const detections = await faceapi.tinyYolov2(document.getElementById('thevideo'), forwardParams)
        // const descriptor1 = await faceapi.computeFaceDescriptor(document.getElementById('theface2'))
        // const descriptor2 = await faceapi.computeFaceDescriptor(document.getElementById('theface'))
